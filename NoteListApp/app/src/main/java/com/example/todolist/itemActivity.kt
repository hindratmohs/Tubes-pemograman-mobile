...
import com.example.todolist.DIO.ToDoItem
...
class itemActivity : AppCompatActivity() {
    ...
    fun updateItem(item : ToDoItem){
        val dialog = AlertDialog.Builder(this)
        dialog.setTitle("Update sub List")
        val view = layoutInflater.inflate(R.layout.dialog_dasboard, null)
        val toDoName = view.findViewById<EditText>(R.id.ev_todo)
    ...
    private fun refreshList(){
        rv_item.adapter = ItemdAdapter(this, dbHandler.getToDoItems(todoid))
    }
    class ItemdAdapter(val activity: itemActivity, val list: MutableList<ToDoItem>) :
        RecyclerView.Adapter<ItemdAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, p1: Int) {
            ...
            holder.delete.setOnClickListener {
                ...
                dialog.setMessage("Do you really want delete this?")
